...
class SubscribePostTest(TestCase):
    ...
    def test_post(self):
        """Valid POST Shoul redirect to /inscricao/"""
    ...
    def test_subscription_email_body(self):
        ...
        self.assertIn('Vinícius Damaceno', email.body)
        self.assertIn('12345678901', email.body)
        self.assertIn('lvdamaceno@gmail.com', email.body)
        self.assertIn('91-98086-9474', email.body)
...
class SubscribeSuccesMassage(TestCase):
